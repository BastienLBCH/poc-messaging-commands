...
KEYCLOAK_PUBLIC_KEY = env("KEYCLOAK_PUBLIC_KEY") if env("KEYCLOAK_PUBLIC_KEY") else ""
KEYCLOAK_ALG = env("KEYCLOAK_ALG") if env("KEYCLOAK_ALG") else ""
KAFKA_BOOTSTRAP_SERVER = env("BOOTSTRAP_SERVERS") if env("BOOTSTRAP_SERVERS") else ""
TOPIC = env("TOPIC") if env("TOPIC") else ""
